...
export default function Footer() {
  return (
    <footer id="contact" className="bg-[var(--bg-secondary)] border-t border-[var(--border)] mt-auto">
      <div className="max-w-[1200px] mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Brand column */}
        <div>
          <div className="mb-4">
            <Logo size="small" clickable priority={false} />
          </div>
          <p className="text-[var(--muted)] text-sm mt-3 mb-2">
          ...
          {/* Socials */}
          <div className="flex gap-4 mt-5" aria-label="Social Links">
            <a
