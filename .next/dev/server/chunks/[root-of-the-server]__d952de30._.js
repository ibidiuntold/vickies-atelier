...
function proxy(request) {
    ...
    if (pathname.startsWith('/images/') || pathname.startsWith('/_next/static/') || pathname.startsWith('/_next/image') || pathname.match(/\.(jpg|jpeg|png|webp|avif|gif|svg|ico|woff|woff2|ttf|otf)$/)) {
